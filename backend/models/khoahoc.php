...
class khoahoc {
    ...
    public function create() {
        $query = "INSERT INTO " . $this->table . " (tenkhoahoc, thoigianhoc, soluongbuoi) VALUES (:tenkhoahoc, :thoigianhoc, :soluongbuoi)";
    ...
    public function update() {
        $query = "UPDATE " . $this->table . " SET tenkhoahoc = :tenkhoahoc, thoigianhoc = :thoigianhoc, soluongbuoi = :soluongbuoi WHERE idkhoahoc = :idkhoahoc";
        $stmt = $this->conn->prepare($query);
